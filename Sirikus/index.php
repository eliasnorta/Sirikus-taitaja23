<?php
    ...
    // selects day for formatted date
...
<body>
    <!-- for page background image under content -->
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            // styling for header when page scrolled down in desktop width
            ...
            // styling for header when page scrolled back to top in desktop width
    ...
    <section id="hero">
        <div class="hero_container">
            ...
            <!-- area for info about upcoming shows and tickets -->
            <div class="circus_frame">
                ...
                <div class="frame_content">
                    ...
                    <!-- tickets with content taken from database -->
                    <div class="frame_tickets">
                        ...
                        <?php
                            ...
                            ?>
                                <div class="lippu">
                                    <!-- date part of the ticket. The date is being formatted using mktime -->
                                    <div class="lippu_date">
                                        <!-- gives results for formatted date -->
                                        <?php
                                            $str = $rows['pvm'];
                                            $x = (explode("-",$str));
                                        ?>
                                    ...
                                    <div class="lippu_info">
                                        ...
                                        <div class="lippu_aika-ja-paikat">
                                            ...
                                            <!-- shows total seats amount and available seats -->
                ...
                <!-- handles click for disabled ticket button -->
                <script type="text/javascript">
                    $(document).ready(function(){
    ...
    <section id="about">
        <div class="about_container">
            ...
            <!-- contact info and embedded google maps map -->
